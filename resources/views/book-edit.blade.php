...
<div class="mt-5 w-50">
    ...
    <form action="/book-edit/{{$book->slug}}" method="post" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="book_code" id="code" class="form-control" placeholder="Books Code" value="{{ $book->book_code }}">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            <label for="currentlmage" class="form-label" style="display: block;"> Current Image </label>
            @if ($book->cover != '')
            <img src="{{ asset('storage/cover/'.$book->cover) }}"  width="260px" alt="">
            @else
            <img src="{{ asset('image/not-found.jpeg') }}" width="260px" alt="">
            @endif
        </div>
